<section class="body">
    <div class="row">
        <div class="small-12 columns">            
            <h3><?=lang('tournaments')?></h3>
            <br/><p><?=lang('homepage_article3')?></p>
            <p><?=lang('tournament_tips')?></p>
            <form method="POST" action="<?=site_url('tournament/submit')?>">
                ...
                <div id="main">
                    ...
                    <!--<input type="text" id="tournament-data" name="tournament-data" >-->
                </div>
                </div>
                <!--<button type="submit" name="tournament_submit" class="button small right"><?=lang('submit')?></button>-->
            </form>
        </div>
    </div>  
</section>
...
function newBracket() {
  $('#editor').empty().bracket({
      save: function(data){
          $('#tournament-data').val(jQuery.toJSON(data))
        }
      })
